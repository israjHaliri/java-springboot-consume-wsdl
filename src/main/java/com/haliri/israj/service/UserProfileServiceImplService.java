 ...
 * 
 */
@WebServiceClient(name = "UserProfileServiceImplService", targetNamespace = "http://service.israj.haliri.com/", wsdlLocation = "http://127.0.0.1:9999/ws/user_profile?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERPROFILESERVICEIMPLSERVICE_QNAME = new QName("http://service.israj.haliri.com/", "UserProfileServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:9999/ws/user_profile?wsdl");
    ...
    public UserProfileService getUserProfileServiceImplPort() {
        return super.getPort(new QName("http://service.israj.haliri.com/", "UserProfileServiceImplPort"), UserProfileService.class);
    }
    ...
    public UserProfileService getUserProfileServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.israj.haliri.com/", "UserProfileServiceImplPort"), UserProfileService.class, features);
    }
